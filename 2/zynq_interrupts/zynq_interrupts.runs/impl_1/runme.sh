...
HD_PWD='D:/project/Zynq-Book-Tutorial/2/zynq_interrupts/zynq_interrupts.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_interrupts_system_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zynq_interrupts_system_wrapper.tcl -notrace
