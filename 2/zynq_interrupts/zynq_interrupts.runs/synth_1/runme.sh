...
HD_PWD='D:/project/Zynq-Book-Tutorial/2/zynq_interrupts/zynq_interrupts.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_interrupts_system_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_interrupts_system_wrapper.tcl
